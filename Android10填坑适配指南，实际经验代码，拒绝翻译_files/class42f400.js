...
"use strict";
var t=e("biz_common/utils/url/parse.js"),a=e("biz_wap/jsapi/core.js"),n=e("biz_wap/utils/wapsdk.js"),i=e("biz_wap/utils/ajax.js"),r=e("common/comm_report.js"),s=void 0,o=[],d={
...
o.push(e),s||(a.on("onMPPageAction",function(e){
...
r.broadcastFrame(i,p.APPMSGAD_READY_ACTION,e),r.listenMessage(window,function(i,t){
t.action===p.GET_APPMSGAD_READY_STATUS_ACTION&&r.postMessage(i.source,p.APPMSGAD_READY_ACTION,e);
});
}
function a(e){
var a=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],g=arguments[2],w=[],l=n.checkNeedAds();
l.is_need_ad=a.forceGetAd?1:l.is_need_ad;
var v=l.is_need_ad,f=m.getQuery("mock"),y=m.getQuery("rtx"),A="/mockserver/mockservercgi-bin/offerTestCase/mmbizwap/mp/getappmsgad",u="/mp/getappmsgad",D="5"===window.item_show_type,j=D&&!_.isNativePage()&&!m.getQuery("get_ad_after_video"),h=c.isUseAd()&&!j,b=window.pos_type_list?JSON.stringify(window.pos_type_list.split("|").map(function(e){
return Number(e);
})):"";
e=e||[];
for(var k=0;k<e.length;k++)0===e[k].indexOf(p.ORIGIN_VIDEO_VID_PREFIX)&&w.push(e[k]);
(f&&"-1"!==f||y)&&(console.info("[广告走mock系统] mockId",f,"rtx",y),u=A),console.info("[广告发送请求] 是否拉取广告",v),
o({
url:u+"?f=json&mockid="+f+"&rtx="+y,
data:{
r:Math.random(),
...
tmp_version:1,
pos_type_list:b,
vid_list:JSON.stringify(h?e:[]),
exportkey:m.getQuery("exportkey"),
waid:m.getQuery("waid")
},
type:"POST",
dataType:"json",
rtId:27613,
...
n.afterGetAdData(l,e),r.setBackgroundClass();
var a=e;
...
var d=a.advertisement_info[o].vid;
d&&"string"==typeof d&&1===a.advertisement_info[o].is_mp_video&&(window.originalVideoAdFramesAdData[d]=r.saveCopy(a.advertisement_info[o]),
_.report120081("0"));
}
...
var s=e("appmsg/log.js"),o=e("biz_wap/utils/ajax.js"),d=e("rt/appmsg/getappmsgext.rt.js"),n=e("a/a.js"),r=e("a/a_utils.js"),m=e("biz_common/utils/url/parse.js"),p=e("a/a_config.js"),c=e("pages/version4video.js"),_=e("common/utils.js");
return{
getAdData:a
};
