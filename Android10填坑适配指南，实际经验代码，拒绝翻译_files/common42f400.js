...
var o=S.visibilityPausePlayer;
o&&o.hasBeginPlay()&&!o.isEnd()&&(o.play4outer(),S.visibilityPausePlayer=null);
}
}
function l(e){
...
1==v.proxyPreloadExper().experSet?y.saveSpeeds({
sample:1,
...
user_define:i
}):2==v.proxyPreloadExper().experSet?y.saveSpeeds({
sample:1,
uin:window.encodeURIComponent(w.toBase64(window.user_uin))||uin,
pid:1045,
speeds:{
...
user_define:i
}):3==v.proxyPreloadExper().experSet?y.saveSpeeds({
sample:1,
uin:window.encodeURIComponent(w.toBase64(window.user_uin))||uin,
pid:1045,
speeds:{
...
user_define:i
}):4==v.proxyPreloadExper().experSet&&y.saveSpeeds({
sample:1,
uin:window.encodeURIComponent(w.toBase64(window.user_uin))||uin,
pid:1045,
speeds:{
...
var d=e("biz_wap/jsapi/log.js"),_=e("biz_common/dom/event.js"),u=e("new_video/player.html.js"),h=e("biz_wap/utils/device.js"),c=e("new_video/ctl.js"),p=e("biz_common/tmpl.js"),g=e("pages/iframe_communicate.js"),f=e("a/a_utils.js"),m=e("biz_common/utils/url/parse.js"),v=e("pages/version4video.js"),y=e("biz_wap/utils/wapsdk.js"),w=e("biz_common/base64.js"),T=e("biz_wap/jsapi/core.js"),b=e("new_video/plugin/util.js"),P=18e4,S={
...
},k=navigator.userAgent,F=function(){
return!0;
}(),M=-1!==k.indexOf("Safari")&&-1!==k.indexOf("Version")&&-1==k.indexOf("Android"),x=function(){
return!!h.browser.M1;
}(),D=function(e,t){
...
},H=!h.canSupportVideo,L=function(e){
var t=$(e.container);
...
var l=e.plugins||[];
this._blockPlugin={};
for(var d=0,_=l.length;_>d;++d){
var c=l[d];
c.setPlayer(this),!!c.init&&c.init();
}
...
var a=e["on"+i];
"function"==typeof a&&a.apply(this,t),"BeginPlay"!=i||null!=o.__replaySec&&0!=o.__replaySec||!h.os.ios||(n.currentTime=.1);
}
},
...
if(e&&e.autoplay&&!M)return this.videoCtlReport({
step:15
}),this._g.hasReportBeginPlay=!0,void this._trigger("readyBeginPlay",e);
if(this.opt.isVideoSharePage&&v.device.inWechat)return this.__firstLoadedFlowNoticeJudge(),
this.videoCtlReport({
step:15
}),this._g.hasReportBeginPlay=!0,void this._trigger("readyBeginPlay",e);
...
if(t&&t>0&&this.container.find(".js_video_length").html(N(t)).show(),1==this.__iosPreloadPause){
var i=this;
setTimeout(function(){
...
t.showLoading("firstTime"),t.__firstLoadedFlowNoticeJudge(),setTimeout(function(){
...
"none"!==o.css("display")&&e._g.isUserPause===!1&&e.__hideFlowNotice(),e.__hideControllTimeout();
},
...
e.log.duration=e.duration,e.duration=e.duration>>0,o.find(".js_total_time").text(N(e.duration)),
...
if(t.__forcePause===!0)return void B(t.id+":timeupdate __forcePause return");
if(t.__hasBeginPlay&&!t.__canplay)return t.showLoading(),!1;
n=t.video,null!=t.__replaySec&&(B(t.id+":timeupdate __replaySec"),n.pause(),n.currentTime=t.__replaySec,
...
B("player inner isend:"+t.isEnd()),t.isEnd()&&(t.changeStatus({
status:"end",
subStatus:""
...
t.showLoading(),t.showCover(),n.pause(),n.src=e,n.load(),n.play(),B(t.id+":stalled"));
}
}),e.on("seeked",function(){
t.__onTouch||(t.changeStatus({
status:"loading",
subStatus:"seeked"
}),n.play()),B("video seeked event");
}),e.off("seeking").on("seeking",function(){
B("seeking,__hasBeginPlay:"+t.__hasBeginPlay),t.__hasBeginPlay&&(t.changeStatus({
status:"loading",
subStatus:"seeking"
}),t.showLoading());
}),e.off("waiting").on("waiting",function(){
if(B("waiting,__hasBeginPlay:"+t.__hasBeginPlay),t.__hasBeginPlay){
t.changeStatus({
status:"loading",
subStatus:"waiting"
...
var i=n.src;
t.showLoading(),t.showCover(),n.pause(),n.src=i,a++,n.load(),n.play(),B(t.id+":waitingHandlerTimer");
}
}
},1e4)),t._trigger("waiting");
}
}),e.off("play playing").on("play playing",function(e){
return t.__forcePause===!0?void B(t.id+":play playing __forcePause return"):(t.changeStatus({
status:"play",
subStatus:e.type
}),setTimeout(function(){
t.adVideoStatus="play";
},10),B(t.id+":play playing"),o.removeClass("switch_on"),o.addClass("switch_off"),
t._hidePlayControllBar(),t.__startCountTime(),void t._trigger("play"));
}),e.off("pause").on("pause",function(){
B(t.id+":video pause event"),t.changeStatus({
status:"pause",
subStatus:""
}),setTimeout(function(){
...
t.hideLoading(),t.__isInFullScreen=!1),B("fullscreenchange state:"+t.__isInFullScreen+"; event type:"+e.type),
...
n.find(".js_btn_play")),s=n.find(".js_btn_play_aria"),r=n.find(".js_video_poster"),l=n.find(".js_switch"),d=n.find(".js_progress_bar"),u=n.find(".js_controll"),c=(n.find(".js_played_bar"),
...
var v,y,w,T,b=0,P=!1,S=0,j=0,C=i.__getDuration(),B=0,k=0,M=1,x=window.user_uin||0,D=0!==x&&Math.floor(x/100)%1e3<M,N=!1,L=0;
c.on("touchstart",function(e){
1==e.targetTouches.length&&i.isPlay()&&(o.blockTouchVideo||(w=v=new Date,T=y={
x:e.targetTouches[0].clientX,
y:e.targetTouches[0].clientY
},k=B=i.getCurTime(),h.os.android&&e.preventDefault()));
...
if(T.x==y.x&&T.y==y.y&&Math.abs(a-T.y)>=10)return void(P=!1);
var s=t-v,r=n-y.x,l=a-y.y,d=Math.sqrt(Math.pow(r,2)+Math.pow(l,2))+j,_=Math.min(Math.ceil(d/s),6);
S=Math.floor(.1*d+.2*_*_*_)*Math.ceil(C/500),j=0==S?d:0,0>r&&(S=-S);
var u=180*Math.atan2(l,r)/Math.PI;
P||(u>=-30&&30>=u&&++b,(u>=150&&180>=u||u>=-180&&-150>=u)&&--b,(b>=4||-4>=b)&&(5>=d?b=0:(L=Math.max(L,_),
P=!0))),P&&(B+=S,0>B&&(B=0),B>C&&(B=1*C),i.__setForwardBar(B),e.preventDefault(),
e.stopPropagation()),y={
x:n,
y:a
},v=t;
...
if(P){
if(i.play(B),n.find(".js_forward").css("display","none"),D&&((new Image).src="/mp/jsmonitor?idkey=28307_29_1",
!N)){
var t=(new Date,{
...
(new Image).src="/mp/jsmonitor?idkey=28307_31_1;28307_33_"+s+";28307_34_"+L,N=!0;
}
i._seekReport(),i._trigger("handDragComplete",{
playTime:B,
startDragVideoTime:k
});
}
S=0,P=!1,b=0;
}),c.on("touchmove MSPointerMove pointermove mousemove",function(e){
i.isInFullScreen()&&!F&&(e.preventDefault(),e.stopPropagation());
}),_.tap(c[0],function(e){
e.target===u[0]||u[0].contains(e.target)||i.isEnd()||i.isPause()||P||i._trigger("touchVideo");
}),_.tap(p[0],function(){
...
t();
}),i.__onTouch=!1,d.on("mousedown",function(e){
i.__hasFuncControllBar&&(u.off("mousemove",i._event.progressBarMousemove).on("mousemove",i._event.progressBarMousemove),
...
d.off("touchmove",i._event.progressBarTouchmove).on("touchmove",i._event.progressBarTouchmove),
d.off("touchend",i._event.progressBarTouchend).on("touchend",i._event.progressBarTouchend);
...
if(v.device.inWechat&&parent.window.lastNetworkType&&parent.window.lastNetworkType.networkType&&parent.window.lastNetworkType.simType&&b.isMobileNetwork(parent.window.lastNetworkType.networkType)&&1!==parent.window.lastNetworkType.simType){
var e=void 0;
...
(l||d>=.5)&&(this.progressBarSeekData.dragTime=r,B("_pointerMoveHandler set currentTime, dragTime:"+this.progressBarSeekData.dragTime+" currentTime:"+this.video.currentTime),
...
this.progressBarSeekData=null,B("_pointerUpHandler dragTime:"+i+" currentTime:"+this.video.currentTime),
setTimeout(function(){
...
this.container.find(".js_video_pause_controll").hide(),this._g.isUserPause&&v.device.inWechat&&("wifi"===this._g.pauseNetType&&b.isVideoNeedFlowNotice(this.opt.flow,3)||b.isNoneNetwork(this._g.pauseNetType)&&b.isVideoNeedFlowNotice(this.opt.flow,4)?this.__showFlowNotice_1():(this._g.isUserPause=!1,
this._g.pauseNetType=null));
},
...
t.find(".js_forward").css("display","block"),t.find(".total_time").text(N(i)),t.find(".js_forward_bar").css("width",100*o+"%"),
...
if(console.log("trigger real play"),o.__iosIsRealPreload&&s(o.video,!1),o.__forcePause=!1,
o.opt.notPauseOtherVideoWhenPlay||g.broadcastMessage({
type:"broadcastPlay",
data:{
id:this.id
}
...
o.log.loadwait_start=+new Date,(!n.attr("src")||i)&&(n.attr("src",e),v.proxyPreloadExper()&&v.proxyPreloadExper().isUsePreload&&h.os.ios&&!o.opt.ad_muted_btn&&!function(){
var e=function t(){
o.__iosPreloadPause=!0,a.pause(),o._trigger("ready",o.opt),a.removeEventListener("canplay",t,!1);
};
a.addEventListener("canplay",e,!1),4!==a.readyState&&(o.__iosPreloadPlayFlag=!0,
o.__iosIsRealPreload=!0,s(a,!0),a.play());
...
c.commReport(i)):c.report(i);
}
},
replay:function(){
h.os.android,this._trigger("replay");
},
resetVideo:function(){
...
this._jsapiLog(a),B(a),g.broadcastMessage({
type:"statusChange",
data:{
id:this.id,
preStatus:o,
...
this.waitingHandlerTimer=null),e.pause(),B(this.id+":pause function"));
},
